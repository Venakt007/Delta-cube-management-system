      ...
      >
        ...
        <div className="bg-gray-50 px-4 py-3 flex justify-between items-center sticky bottom-0">
          {candidate.resume_url && (
            <a
              href={candidate.resume_url.startsWith('http') ? candidate.resume_url : `${window.location.origin}${candidate.resume_url}`}
              target="_blank"
          ...
          {candidate.edited_resume_url && candidate.source === 'dashboard' && (
            <a
              href={candidate.edited_resume_url.startsWith('http') ? candidate.edited_resume_url : `${window.location.origin}${candidate.edited_resume_url}`}
              target="_blank"
              rel="noopener noreferrer"
